...
using MVCMemberships.Entities;
using MVCMemberships.Models;

namespace MVCMemberships.Areas.Admin.Controllers
{
    public class ProductLinkTextController : Controller
    {
        ...
        {
            return View(await db.ProductLinktext.ToListAsync());
        }
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            ProductLinkText productLinkText = await db.ProductLinktext.FindAsync(id);
        ...
        {
            ProductLinkText productLinkText = await db.ProductLinktext.FindAsync(id);
            db.ProductLinktext.Remove(productLinkText);
            await db.SaveChangesAsync();
            return RedirectToAction("Index");
        }
